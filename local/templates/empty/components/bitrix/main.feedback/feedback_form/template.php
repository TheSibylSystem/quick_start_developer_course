    ...
    <div class="row">
        <div class="col-lg-8 col-md-8">
            ...
            <div class="form-group">
				...
				for="input-9" 
				class="col-sm-4 col-xs-12 control-label
				<? if (empty($arParams["REQUIRED_FIELDS"]) || in_array("EMAIL", $arParams["REQUIRED_FIELDS"])): ?> required<? endif; ?>"> E-mail: 
				</label>
                ...
                <div class="col-sm-8">
					...
					placeholder="info@intervolga.ru"
            ...
            <div class="form-group">
				...
				for="input-10" 
				class="col-sm-4 col-xs-12 control-label
				<? if (empty($arParams["REQUIRED_FIELDS"]) || in_array("MESSAGE", $arParams["REQUIRED_FIELDS"])): ?> required<? endif; ?>"> Текст сообщения: 
				</label>
